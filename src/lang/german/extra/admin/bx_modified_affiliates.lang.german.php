 ...
 */
  ...
  defined('TABLE_HEADING_ACTION') || define('TABLE_HEADING_ACTION', 'Aktion');
...
define('BX_MALE', 'Herr');
define('BX_FEMALE', 'Frau');
define('BX_DIVERSE', 'Divers');
define('BX_CATEGORY_COMPANY', 'Firma');
define('BX_ENTRY_AFFILIATE_COMPANY_TAXID', 'Ust-IdNr. / Steuernummer');
define('BX_CATEGORY_PAYMENT_DETAILS', 'Zahlungsdetails');
define('BX_ENTRY_AFFILIATE_PAYMENT_CHECK', 'Zahlung per Scheck');
define('BX_ENTRY_AFFILIATE_PAYMENT_PAYPAL', 'Zahlung per PayPal');
define('BX_ENTRY_AFFILIATE_PAYMENT_BANK_NAME', 'Bankname');
define('BX_ENTRY_AFFILIATE_PAYMENT_BANK_BRANCH_NUMBER', 'Bankleitzahl');
define('BX_ENTRY_AFFILIATE_PAYMENT_BANK_SWIFT_CODE', 'SWIFT-Code');
define('BX_ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NAME', 'Kontoinhaber');
define('BX_ENTRY_AFFILIATE_PAYMENT_BANK_ACCOUNT_NUMBER', 'Kontonummer');
define('BX_ENTRY_AFFILIATE_COMMISSION', 'Provision');
define('BX_ENTRY_AFFILIATE_TIERS_ALLOWED', 'Mehrstufig (Tiers)');
